...
**Documentation Index:** Learn about move building blocks in this documentation.

---

---
title: "Movement SDK building blocks"
description: "Add prebuilt body tracking and networked character components to your Unity project with minimal setup."
...
- [Body tracking samples](/documentation/unity/body-tracking-samples/): sample scenes that apply body retargeting to two characters
- [Troubleshooting Movement SDK](/documentation/unity/move-troubleshooting/): recommendations on resolving issues with Movement SDK components