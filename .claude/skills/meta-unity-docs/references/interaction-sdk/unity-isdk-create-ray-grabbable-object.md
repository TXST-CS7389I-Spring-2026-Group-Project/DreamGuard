# Unity Isdk Create Ray Grabbable Object

**Documentation Index:** Learn about unity isdk create ray grabbable object in this documentation.

---

---
title: "Creating Ray Grabbable Objects"
description: "Using the quick action utility to automate setting up objects within the scene to be grabbable via ray casting."
...
## How do I make an object grabbable using ray-casting?

1. Right-click on the object you want to make grabbable via ray-casting and select **Interaction SDK** > **Add Ray Grab Interaction**. The Ray Grab wizard appears.

    

1. In the Ray Grab wizard, select **Fix All** to fix any errors. This will add missing components or fields if they're required.

    

1. If you want to further customize the interaction, adjust the interaction's settings in the wizard. For details on the available options, please see the [Ray Grab Quick Action](/documentation/unity/unity-isdk-ray-grab-quick-action) documentation.
