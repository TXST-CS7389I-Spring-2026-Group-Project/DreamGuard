# Xrsim Session Capture 1.0

**Documentation Index:** Learn about xrsim session capture 1.0 in this documentation.
...
Session Capture is valuable for automated tests in Continuous Automation or when testing multiplayer setups by playing against yourself. For more details, please visit [Meta XR Simulator Automated Testing](/documentation/unity/xrsim-unity-automated-testing-1.0/).