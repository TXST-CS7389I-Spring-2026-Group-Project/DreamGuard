# Voice Sdk Tts Overview

**Documentation Index:** Learn about voice sdk tts overview in this documentation.

---

---
title: "Text-to-Speech Overview"
description: "Set up text-to-speech audio playback in Unity using the Voice SDK TTSService prefab and TTSSpeaker script."
---
...
2. Generate a new Wit Configuration using the Wit Configurations menu within the **Meta** > **Voice SDK** > **Voice HUB**.  Ensure it refreshes successfully and displays all voices available for your configuration.
...
4. In your scene heirarchy navigate inside the newly generated **TTS** Game Object to select the **TTSWitService** Game Object and adjust the inspector to fit your needs:
    ...
    2. Once your configuration is setup, go to **Preset Voice Settings** and setup any voices that might be shared by multiple **TTSSpeakers**. For more information, see [TTS Voice Customization](/documentation/unity/voice-sdk-tts-voice-customization).
       
    3. Under **TTS Runtime Cache (Script)**, adjust the settings to indicate how often clips will be automatically uploaded from memory. For more information, see [TTS Cache Options](/documentation/unity/voice-sdk-tts-cache-options/).
