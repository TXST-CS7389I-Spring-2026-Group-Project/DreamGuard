...
**Documentation Index:** Learn about ps pgsg in this documentation.

---

---
title: "Getting Started With Platform Solutions"
description: "Set up your development environment and perform the basic steps to use the Platform SDK."
