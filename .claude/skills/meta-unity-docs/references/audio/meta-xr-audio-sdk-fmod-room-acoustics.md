# Meta Xr Audio Sdk Fmod Room Acoustics

**Documentation Index:** Learn about meta xr audio sdk fmod room acoustics in this documentation.

---

---
title: "Apply Room Acoustics in FMOD"
description: "Add early reflections and reverb to your FMOD audio sources by configuring room acoustics in Unity."
---
...
1. In the space before the Fader, right-click (Cmd+click on Mac) and select **Add Effect > Plug-in Effects > Meta > MetaXRAudio Reflections**.
...
- See [Raytraced Acoustics for Unity Overview](/documentation/unity/meta-xr-acoustic-ray-tracing-unity-overview/) to
learn how to use advanced Raytraced Acoustics in place of the Shoebox Room model.
- See [Meta XR Audio Plugin for FMOD - Ambisonic](/documentation/unity/meta-xr-audio-sdk-fmod-ambisonic/) to
learn how to render ambisonic audio with the Meta XR Audio SDK.